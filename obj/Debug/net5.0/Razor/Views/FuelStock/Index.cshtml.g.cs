#pragma checksum "C:\Users\MBComputer\Desktop\Capstonetest1\Views\FuelStock\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4ed4512b2c781d6bfcac9a2dcb229b6b88e2163e"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_FuelStock_Index), @"mvc.1.0.view", @"/Views/FuelStock/Index.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4ed4512b2c781d6bfcac9a2dcb229b6b88e2163e", @"/Views/FuelStock/Index.cshtml")]
    ...
    public class Views_FuelStock_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\MBComputer\Desktop\Capstonetest1\Views\FuelStock\Index.cshtml"
...
<!-- line CHART 2-->
    ...
    ");
            WriteLiteral("    </div>\r\n        <!-- /.card-body -->\r\n    </div>\r\n    <!-- /.card -->\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4ed4512b2c781d6bfcac9a2dcb229b6b88e2163e4975", async() => {
            }
            );
...
async function myFunction(){
  ...
  await fetch(`https://localhost:5001");
            WriteLiteral(@"/api/pi/InventoryStockDiesel/${d3}`)
  .then(response => response.json())
  ...
  .then(response => response.json())
  .then(data =>");
            WriteLiteral(@" Diesel11 = data.result[0].values)
  ...
  .then(response => response.json())
  .then(data => Diesel15 = data.result[0].value");
            WriteLiteral(@"s)
  ...
  await f");
            WriteLiteral(@"etch(`https://localhost:5001/api/pi/InventoryStockDiesel/${d28}`)
  .then(response => response.json())
 ...
 ");
            WriteLiteral(@" await fetch(`https://localhost:5001/api/pi/InventoryStockGas95/${d2}`)
  .then(response => response.json())
  ...
  .t");
            WriteLiteral(@"hen(() => console.log(Gas10));
  ...
  await fetch(`https://localhost:5001/api/pi/Inven");
            WriteLiteral(@"toryStockGas95/${d15}`)
  .then(response => response.json())
  ...
  .then(response => response.json())
  .then(data => Gas19");
            WriteLiteral(@" = data.result[0].values)
  ...
  await fetch(`https://localhost:5001/api/pi/InventoryStockGas95/${");
            WriteLiteral(@"d28}`)
  .then(response => response.json())
...
");
            WriteLiteral("    lineChartData.datasets.fill = false;\r\n");
            WriteLiteral(@"
...
");
            WriteLiteral("    lineChartData2.datasets.fill = false;\r\n");
            WriteLiteral(@"
